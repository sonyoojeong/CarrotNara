  	...
  	<script type="text/javascript">
  		...
  		function validCheck(){/* 폼 유효성 검사 */
  			...
  			if(subject.length < 4 || subject.length > 20){
  				alert('글 제목은 4글자 이상 20글자 이하이어야 합니다.');
  				$('#subject').focus() ;
  				return false ;
  			}
...
<body>
	<div class="container mt-3 col-md-5">
		<h2>공지사항 등록</h2>
		<p>관리자가 공지사항을 등록하는 페이지</p>
		
		<form action="<%=withFormTag%>" method="post">
		<input type="hidden" name="command" value="boInsert5">
			<div class="input-group">
				<span class="input-group-text col-md-2">글번호</span> 
				<input id="fakeno" name="fakeno" type="number" class="form-control" placeholder="" disabled="disabled">
			</div> 
			<div class="input-group">

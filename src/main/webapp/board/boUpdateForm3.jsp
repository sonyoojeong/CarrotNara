...
<body>
	<div class="container mt-3 col-md-5">
		<h2>거래 후기 수정</h2>
		<p>거래 후기를 수정하는 페이지입니다.</p>
		
		<form action="<%=withFormTag%>" method="post" encytpe="multipart/form-data">
			<input type="hidden" name="command" value="boUpdate3">
			...
			<div class="input-group">
				<span class="input-group-text col-md-2">사진</span> 
				<input id="image01" name="image01" type="file" class="form-control" placeholder="" value="${bean.image01}">
				<input id="image02" name="image02" type="file" class="form-control" placeholder="" value="${bean.image02}">
			</div>  

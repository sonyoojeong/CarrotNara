...
<body>
	<div class="container mt-3 col-md-5">
		<h2>사기이력 수정</h2>
		<p>관리자가 사기이력을 수정하는 페이지입니다.</p>
		
		<form action="<%=withFormTag%>" method="post">
			<input type="hidden" name="command" value="boUpdate6">
			...
			<div class="input-group">
				<span class="input-group-text col-md-3">게시물 번호</span> 
			...
			<div class="input-group">
				...
				<input id="fakeid" name="fakeid" disabled="disabled" type="text" class="form-control" placeholder="" value="${bean.id}">
				<input type="hidden" id="id" name="id" value="${bean.id}">
			</div>
			<div class="input-group">
				<span class="input-group-text col-md-3">아이디</span> 
				<input id="mid" name="mid" type="text" class="form-control" placeholder="" value="${bean.mid}">
			</div>
			<div class="input-group">
				<span class="input-group-text col-md-3">이름</span> 
				<input id="name" name="name" type="text" class="form-control" placeholder="" value="${bean.name}">
			</div>
			<div class="input-group">
			...
			<div class="input-group">
				...
				<input id="fraud" name="fraud" type="text" class="form-control" placeholder="" value="${bean.fraud}">
			</div>  
			
			<div class="input-group">
				<span class="input-group-text col-md-3">사기이력 세부사항</span> 
				<input id="frauddetail" name="frauddetail" type="text" class="form-control" placeholder="" value="${bean.frauddetail}">
			</div>  
			<div class="input-group">

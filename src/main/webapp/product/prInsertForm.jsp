     ...
     <script type="text/javascript">
        ...
        function validCheck(){/* 폼 유효성 검사 */
           ...
           if(comments.length < 1 || comments.length > 100){
              alert('상품에 대한 설명은 1글자 이상 100글자 이하이어야 합니다.');
              $('#comments').focus();
              return false;
           }
           ...
           if(price == ''||isNaN(price)==true){
              ...
              if(numPrice < 1 || numPrice > 100000000){
                 alert('가격은 1원 이상 100000000원 이하이어야 합니다.');
                   $('#price').focus();
                   return false;
              }   
           }
           ...
           if(category == '-'){/* 코딩할 때 option의 value 속성을 하이픈으로 설정했습니다. */
              alert('카테고리를 선택해 주세요.');
              $('#category').focus();
              return false;
           }
         ...
         var inputdate = $('#inputdate').val();
           ...
           var cate = $('#cate').val();
           if($(':radio[name="cate"]:checked').length < 1){
              alert('거래현황을 선택해 주세요.');
              $('#cate').focus();
   ...
   <div class="container mt-3 col-md-5">
      ...
      <form action="<%=withFormTag%>" method="post" enctype="multipart/form-data">
         ...
         <div class="input-group">
            ...
            <!-- <textarea id="comments" name="comments" class="form-control" placeholder="" rows="10" cols="50"></textarea> -->
         ...
         <div style="display:none;" class="input-group">
            ...
            <div class= "form-control radio_gender">
               <label class="radio-inline"> <input id="cate" name="cate" type="radio" value="거래중" checked="checked">거래가능</label>
         ...
         <div class="input-group">
            ...
            type="text" class="btn btn-info m-btn--air" onclick="execDaumPostcode()" >
            </div>
         ...
         <div class="container mt-3">
            <button type="submit" class="btn btn-outline-primary" onclick="return validCheck();">등록</button>
            &nbsp;&nbsp;&nbsp;
